...
provider "aws" {
  ...
  default_tags {
    ...
    tags = {"Account":"prod","AppliedFrom":"terraform-cloud","ManageLevel":"product","ManagedBy":"terraform","TerraformCloudWorkspace":"2-products_prod_demo-back","TerraformModuleSource":"dasmeta/service/aws","TerraformModuleVersion":"1.1.4"}
  }
}
provider "kubernetes" {
